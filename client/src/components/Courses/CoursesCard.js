    ...
    <Card className={classes.root} elevation={3}>
      ...
      />
        <CardContent>
          ...
          <Typography variant="body2" color="textSecondary" component="p">
          <a rel="Courses Content" href={course.Content} target="_blank">Course Content </a>
          </Typography>
          <Typography variant="body2" color="textSecondary" component="p"> Category:  
           {course.categorie.categorieName}
          </Typography>
          <Typography variant="body2" color="textSecondary" component="p">
